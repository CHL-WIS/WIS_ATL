...
ccmrun /outdat/198002_WIS_PAC_WW3_OWI_ST4/serial_fields.sh > serial_fields.out
wait

ccmrun /outdat/198002_WIS_PAC_WW3_OWI_ST4/netcdf_fields.sh > netcdf_fields.out
